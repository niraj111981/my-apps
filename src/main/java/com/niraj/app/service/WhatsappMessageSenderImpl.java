...
public class WhatsappMessageSenderImpl implements MessageSender {
    ...
    /*public static void main(String[] args) throws Exception {
        String number = "7903752832";  //  TODO: Specify the recipient's number here. NOT the gateway number
        String message = "Sending message using code?";

        WhatsappMessageSenderImpl.sendMessage(number, message);
    }*/
